...
struct NewGadget TransferNGad[] = {
        ...
        196, 61, 81, 11, (UBYTE *)"Transfer\BB", NULL, GD_TransferOther, PLACETEXT_IN, NULL, (APTR)TransferOtherClicked,
        196, 45, 81, 11, (UBYTE *)"Transfer\AB", NULL, GD_TransferThis, PLACETEXT_IN, NULL, (APTR)TransferThisClicked,
...
struct NewGadget BuyShipNGad[] = {
        ...
        68, 69, 81, 11, (UBYTE *)"\ABPrevious", NULL, GD_Previous, PLACETEXT_IN, NULL, (APTR)PreviousClicked,
        156, 69, 49, 11, (UBYTE *)"Next\BB", NULL, GD_Next, PLACETEXT_IN, NULL, (APTR)NextClicked
};
...
struct NewGadget AutopilotNGad[] = {
    76, -3, 37, 12, (UBYTE *)"\B0", NULL, GD_LatDegrees, PLACETEXT_RIGHT, NULL, (APTR)LatDegreesClicked,
    ...
    76, 13, 37, 12, (UBYTE *)"\B0", NULL, GD_LonDegrees, PLACETEXT_RIGHT, NULL, (APTR)LonDegreesClicked,
...
int OpenAutopilotWindow( void )
{
    ...
    if ( ! ( AutopilotWnd = OpenWindowTags( NULL,
                ...
                WA_ScreenTitle, "GadToolsBox V2.0b \A9 1991-1993",
                WA_CustomScreen,    Scr,
                TAG_DONE )))
    return( 4L );
